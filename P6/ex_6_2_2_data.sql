...
INSERT INTO Produto (
    ...
    (10009, 'Lixívia de Cor', 1.85, 23, 9382),
    (10010, 'Amaciador Neutro', 4.05, 23, 932432),
    (10011, 'Água Natural', 0.55, 6, 919323),
    (10012, 'Pão de Leite', 0.15, 6, 5434),
...
INSERT INTO Fornecedor (
    nif, nome, fax, endereco, condpag, tipo
) VALUES
    ...
    (509987654, 'MaduTex', 234873434, 'Estrada da Circunvalação 213', 30, 104),
    (590972623, 'ConservasMac', 234112233, 'Rua da Recta 233', 30, 104);


-- INSERT INTO Encomenda
INSERT INTO Encomenda (
    numero, [data], fornecedor
) VALUES
